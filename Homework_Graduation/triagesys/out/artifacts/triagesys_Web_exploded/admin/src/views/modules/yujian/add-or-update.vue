<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="是否发热" prop="shifoufare">
          <el-input v-model="ruleForm.shifoufare" 
              placeholder="是否发热" clearable  :readonly="ro.shifoufare"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="是否新冠肺炎" prop="shifouxinguanfeiyan">
          <el-input v-model="ruleForm.shifouxinguanfeiyan" 
              placeholder="是否新冠肺炎" clearable  :readonly="ro.shifouxinguanfeiyan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="是否新冠肺炎" prop="shifouxinguanfeiyan">
              <el-input v-model="ruleForm.shifouxinguanfeiyan" 
                placeholder="是否新冠肺炎" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shifoufare = true;
          ...
          if(o=='shifouxinguanfeiyan'){
            this.ruleForm.shifouxinguanfeiyan = obj[o];
	    this.ro.shifouxinguanfeiyan = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yujian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yujianCrossAddOrUpdateFlag = false;
                  this.parent.search();
