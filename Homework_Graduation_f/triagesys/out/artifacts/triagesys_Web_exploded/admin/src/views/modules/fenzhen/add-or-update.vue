<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="挂号编号" prop="guahaobianhao">
          <el-input v-model="ruleForm.guahaobianhao" 
              placeholder="挂号编号" clearable  :readonly="ro.guahaobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="挂号编号" prop="guahaobianhao">
              <el-input v-model="ruleForm.guahaobianhao" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.tu" label="图" prop="tu">
          <file-upload
          tip="点击上传图"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.tu?ruleForm.tu:''"
          @change="tuUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.tu" label="图" prop="tu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tu.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主治医生" prop="zhuzhiyisheng">
          <el-input v-model="ruleForm.zhuzhiyisheng" 
              placeholder="主治医生" clearable  :readonly="ro.zhuzhiyisheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主治医生" prop="zhuzhiyisheng">
              <el-input v-model="ruleForm.zhuzhiyisheng" 
                placeholder="主治医生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshimingcheng = true;
          ...
          if(o=='tu'){
            this.ruleForm.tu = obj[o];
	    this.ro.tu = true;
            continue;
          }
          if(o=='zhuzhiyisheng'){
            this.ruleForm.zhuzhiyisheng = obj[o];
	    this.ro.zhuzhiyisheng = true;
            continue;
          }
          if(o=='guahaofei'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fenzhen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fenzhenCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    tuUploadChange(fileUrls) {
	this.ruleForm.tu = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
