  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='huanzhe'"  label="血型" prop="xuexing">
          <el-select v-model="ruleForm.xuexing" placeholder="请选择血型">
            <el-option
                v-for="(item,index) in huanzhexuexingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huanzhe'"  label="病史" prop="bingshi">
          <el-input v-model="ruleForm.bingshi"               placeholder="病史" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='huanzhe'"  label="诊断" prop="zhenduan">
          <el-input v-model="ruleForm.zhenduan"               placeholder="诊断" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  mounted() {
    ...
    this.huanzhexuexingOptions = "A,B,AB,O".split(',')
  },
  methods: {
